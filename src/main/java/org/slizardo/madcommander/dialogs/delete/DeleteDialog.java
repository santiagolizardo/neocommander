...
public class DeleteDialog extends JDialog {
	...
	public DeleteDialog() {
		...
		label = new JLabel("Do you really want to delete the selected files/directories?");
	...
	private void defineLayout() {
		...
		layout.putConstraint(SpringLayout.NORTH, scroll, 5, SpringLayout.SOUTH, label);
		
		layout.putConstraint(SpringLayout.WEST, ok, 5, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, ok, 5, SpringLayout.SOUTH, scroll);
		
		layout.putConstraint(SpringLayout.NORTH, cancel, 5, SpringLayout.SOUTH, scroll);
		
		layout.putConstraint(SpringLayout.EAST, contentPane, 5, SpringLayout.EAST, scroll);
		layout.putConstraint(SpringLayout.SOUTH, contentPane, 5, SpringLayout.SOUTH, ok);
		layout.putConstraint(SpringLayout.EAST, cancel, 0, SpringLayout.EAST, scroll);
