...
public class DateComparator implements Comparator<FileListingRow> {

	@Override
	public int compare(FileListingRow firstRow, FileListingRow secondRow) {
		long firstDate = firstRow.getFile().lastModified();
		long secondDate = secondRow.getFile().lastModified();
