...
public class FileListingKeyListener extends KeyAdapter {
	...
	public void keyPressed(KeyEvent event) {
		...
		switch (keyCode) {
			...
			case KeyEvent.VK_ASTERISK -> mainWindow.getSource().invertSelection();
			case KeyEvent.VK_ENTER -> mainWindow.getSource().execute();
			...
			default -> {
				...
				if (modifiers == KeyEvent.CTRL_DOWN_MASK) {
					if (keyCode == KeyEvent.VK_D) {
						var popup = new BookmarksPopup(mainWindow);
